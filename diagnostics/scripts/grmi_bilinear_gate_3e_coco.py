# GRMI Bilinear + Old-Class Gate, 3 epochs.
#
# Gate: R = LN(Bilinear(M, T_pool)) * sigmoid(MLP_gate(M))
# The gate MLP learns to suppress R at old-class positions,
# preserving ori_ap while improving new_ap.
#
# Key ablation: set use_old_gate=False to compare against no-gate Bilinear.
